...
# these are present in all trials
common_events = {
    "inter_trial": {
    ...
    "stimL": {
        ...
        "window": (0, 0.2),
        "query": "stim_left",
        "label": r"$\mathrm{L_{stim}}$",
    },
    "stimR": {
        "align_event": "stimOn_times",
        "window": (0, 0.2),
        "query": "stim_right",
        "label": r"$\mathrm{R_{stim}}$",
    },
    "choiceL": {
        "align_event": "firstMovement_times",
        "window": (-0.15, 0),
    ...
    "mistake_m": {
        ...
        "window": (-0.15, 0.0),
        "query": "feedbackType == -1.0",
        "label": r"$\mathrm{mistake, m}$",
    },
    "mistake_s": {
        "align_event": "stimOn_times",
        "window": (-0.15, 0.0),
        "query": "feedbackType == -1.0",
        "label": r"$\mathrm{mistake, s}$",
    },
}
...
# event_definitions_with_mistakes = {
#     "inter_trial": {
#         "align_event": "stimOn_times",
#         "window": (-1.15, -1),
#         "query": "intervals_0 > 0",
...
#         "align_event": "stimOn_times",
#         "window": (0.0, 0.15),
#         "query": "deep_block == False",
#         "label": r"$\mathrm{block_change, s}$",
#     },
#     "block_change_m": {
#         "align_event": "firstMovement_times",
#         "window": (0.0, 0.15),
#         "query": "deep_block == False",
#         "label": r"$\mathrm{block_change, m}$",
#     },
#     "choiceL": {
#         "align_event": "firstMovement_times",
#         "window": (0, 0.15),
